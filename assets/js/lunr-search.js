window.addEventListener("DOMContentLoaded", event => {
    ...
    function search(term, doNotAddState) {
        try {
            ...
            {{ if .Site.Params.enablenavbarbarToggle }}
                let navbarToggleLabel = document.querySelector('.navbar-toggle');
                if (navbarToggleLabel && navbarbarToggleLabel.classList.contains("open")) {
                    document.getElementById(navbarToggleLabel.getAttribute("for")).click();
                }
            {{ end }}
        }
        finally {
